    ...
    <section className="relative z-10 mx-auto max-w-6xl px-4 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 items-stretch">
        ...
        <div className="glass-card md:col-span-2 rounded-2xl p-6 flex flex-col justify-between relative overflow-hidden group">
          <div className="absolute top-0 right-0 w-64 h-64 bg-[#ff5a1f]/10 rounded-full blur-3xl pointer-events-none group-hover:bg-[#ff5a1f]/20 transition-all duration-500"></div>
          
          <div>
            <div className="w-10 h-10 rounded-xl bg-[#ff5a1f]/15 border border-[#ff5a1f]/35 flex items-center justify-center text-[#ff5a1f] mb-4">
              <Network className="w-5 h-5" />
            </div>
            <h3 className="text-xl font-bold text-[#f5efe9] tracking-tight mb-2">
              Autonomous GraphRAG Traversal
            </h3>
            <p className="text-sm text-[#f5efe9]/80 leading-relaxed mb-6">
          ...
          <div className="rounded-xl border border-[#ff5a1f]/20 bg-[#070302]/90 p-3 font-mono text-xs text-[#f5efe9]">
            <div className="flex items-center justify-between pb-2 mb-2 border-b border-white/5 text-[10px] text-[#f5efe9]/50">
              <span>TRAVERSAL_QUERY.py</span>
              <span className="text-[#ff5a1f]">STATUS: REASONING</span>
            </div>
            <p className="text-[#ff8a50]">$ vestigium trace --repo &quot;auth-gateway&quot; --depth 3</p>
            <p className="text-[#f5efe9]/60 mt-1">Found 14 Nodes, 18 Links • High Blast Radius (CVSS 9.8)</p>
            <p className="text-[#ff2a1f] mt-0.5">↳ Route: /auth/v1/token -&gt; jsonwebtoken@8.5.1 -&gt; CVE-2022-23529</p>
          </div>
        </div>
        ...
        <div className="glass-card md:col-span-1 lg:col-span-2 rounded-2xl p-6 flex flex-col justify-between relative overflow-hidden group">
          <div className="absolute bottom-0 right-0 w-48 h-48 bg-[#d946ef]/10 rounded-full blur-2xl pointer-events-none group-hover:bg-[#d946ef]/20 transition-all duration-500"></div>
          
          <div>
            <div className="w-10 h-10 rounded-xl bg-[#d946ef]/15 border border-[#d946ef]/35 flex items-center justify-center text-[#d946ef] mb-4">
              <Database className="w-5 h-5" />
            </div>
            <h3 className="text-xl font-bold text-[#f5efe9] tracking-tight mb-2">
              Neo4j Cypher Generator
            </h3>
            <p className="text-sm text-[#f5efe9]/80 leading-relaxed mb-4">
          ...
          <div className="rounded-xl border border-[#d946ef]/25 bg-[#070302]/90 p-3 font-mono text-xs text-[#f5efe9]/80">
        ...
        <div className="glass-card md:col-span-2 lg:col-span-2 rounded-2xl p-6 flex flex-col justify-between relative overflow-hidden group">
          ...
          <div>
            <div className="w-10 h-10 rounded-xl bg-emerald-500/15 border border-emerald-500/35 flex items-center justify-center text-emerald-400 mb-4">
          ...
          <button
            ...
            className="w-fit inline-flex items-center gap-2 rounded-lg bg-[#ff5a1f]/20 border border-[#ff5a1f]/40 px-4 py-2 text-xs font-mono text-[#ff8a50] hover:bg-[#ff5a1f]/30 transition-all cursor-pointer"
          >
        ...
        <div className="glass-card md:col-span-1 lg:col-span-2 rounded-2xl p-6 flex flex-col justify-between relative overflow-hidden group">
          <div className="absolute bottom-0 left-0 w-48 h-48 bg-[#ff5a1f]/10 rounded-full blur-2xl pointer-events-none group-hover:bg-[#ff5a1f]/20 transition-all duration-500"></div>
